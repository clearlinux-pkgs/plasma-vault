...
Source0  : https://download.kde.org/stable/plasma/5.27.4/plasma-vault-5.27.4.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.4/plasma-vault-5.27.4.1.tar.xz.sig
...
%prep
%setup -q -n plasma-vault-5.27.4.1
cd %{_builddir}/plasma-vault-5.27.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680713873
mkdir -p clr-build
pushd clr-build
