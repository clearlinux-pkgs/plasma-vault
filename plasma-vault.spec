...
Version  : 5.16.2
Release  : 20
URL      : https://download.kde.org/stable/plasma/5.16.2/plasma-vault-5.16.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.16.2/plasma-vault-5.16.2.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.2/plasma-vault-5.16.2.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1561482907
mkdir -p clr-build
pushd clr-build
