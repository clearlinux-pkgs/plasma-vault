...
Version  : 6.3.4
Release  : 113
URL      : https://download.kde.org/stable/plasma/6.3.4/plasma-vault-6.3.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.4/plasma-vault-6.3.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.4/plasma-vault-6.3.4.tar.xz.sig
...
Patch1: backport-a982e58679caa583ceb4cc883d1c1923dab54db9.patch
...
%setup -q -n plasma-vault-6.3.4
cd %{_builddir}/plasma-vault-6.3.4
%patch -P 1 -p1
pushd ..
cp -a plasma-vault-6.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744216562
mkdir -p clr-build
pushd clr-build
