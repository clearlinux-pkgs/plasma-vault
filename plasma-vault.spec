...
Version  : 5.16.3
Release  : 21
URL      : https://download.kde.org/stable/plasma/5.16.3/plasma-vault-5.16.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.16.3/plasma-vault-5.16.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.3/plasma-vault-5.16.3.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562769086
mkdir -p clr-build
pushd clr-build
