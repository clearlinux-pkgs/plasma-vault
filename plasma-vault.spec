...
Version  : 5.17.4
Release  : 28
URL      : https://download.kde.org/stable/plasma/5.17.4/plasma-vault-5.17.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.17.4/plasma-vault-5.17.4.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.17.4/plasma-vault-5.17.4.tar.xz.sig
...
%prep
%setup -q -n plasma-vault-5.17.4
cd %{_builddir}/plasma-vault-5.17.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575386889
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/plasma-vault-5.17.4/COPYING %{buildroot}/usr/share/package-licenses/plasma-vault/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/plasma-vault-5.17.4/COPYING.LGPL-2 %{buildroot}/usr/share/package-licenses/plasma-vault/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/plasma-vault-5.17.4/COPYING.LIB %{buildroot}/usr/share/package-licenses/plasma-vault/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
