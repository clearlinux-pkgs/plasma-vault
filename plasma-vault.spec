...
Version  : 5.16.5
Release  : 23
URL      : https://download.kde.org/stable/plasma/5.16.5/plasma-vault-5.16.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.16.5/plasma-vault-5.16.5.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.16.5/plasma-vault-5.16.5.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567651355
mkdir -p clr-build
pushd clr-build
