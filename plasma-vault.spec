...
Source0  : https://download.kde.org/stable/plasma/6.1.3/plasma-vault-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/plasma-vault-6.1.3.tar.xz.sig
...
%setup -q -n plasma-vault-6.1.3
cd %{_builddir}/plasma-vault-6.1.3
pushd ..
cp -a plasma-vault-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721158996
mkdir -p clr-build
pushd clr-build
